...
<button class="gaming-btn" onclick="revealNextCard()">I Tried It!</button>`,
  ...
  title: "⚙️ The Secrets of Arduino Code: From Void to Victory",
  sections: [
    {
      title: "The Programming Ritual Begins",
      modules: [
        {
          title: "The Code Awakens: Understanding Arduino Program Structure",
          lessons: [
            {
              title: "What Even *Is* the Structure?",
              content: `<div class='card'>Before we start throwing code like confetti, let's understand what an Arduino sketch actually <b>is</b>.</div>
<div class='card'>Every Arduino program has two mandatory functions: <code>setup()</code> and <code>loop()</code>. Think of <code>setup()</code> as setting the stage — it runs <b>once</b>. The <code>loop()</code>? That's the endless show — it keeps running again and again.</div>
<div class='card'><pre><code>void setup() {
  // setup code here
}
...
<div class='card'>This is your skeleton for every sketch. Everything else you add will go inside one of these two.</div>
<button class='gaming-btn' onclick='revealNextCard(this)'>Show Next</button>`,
              image: "url",
              audio: "url"
            },
            {
              title: "Mini Game: Code Order Challenge",
              content: `<style>.dropbox {border: 2px dashed #999; padding: 20px; margin: 10px; min-height: 50px;}</style>
<div class='card'>Can you place the blocks in correct Arduino order?</div>
<div class='card'><div id='game-area'>
  <div draggable='true' ondragstart='drag(event)' id='loop' style='padding:10px;border:1px solid #000;'>void loop()</div>
  <div draggable='true' ondragstart='drag(event)' id='setup' style='padding:10px;border:1px solid #000;'>void setup()</div>
...
<button class='gaming-btn' onclick='revealNextCard(this)'>Show Next</button>`,
            ...
            {
              title: "Watch and Learn: Code Skeleton",
              content: `<iframe width='100%' height='315' src='https://www.youtube.com/embed/BQoPzjq3jaY' title='Arduino Program Structure'></iframe>
<div class='card'>This video breaks down the structure visually. Great for those who prefer watching over reading!</div>
<button class='gaming-btn' onclick='revealNextCard(this)'>Show Next</button>`,
              image: "url",
              audio: "url"
            },
            {
              title: "How the Code Flows: setup() vs loop()",
              content: `<div class='card'>Let’s say you want your LED to blink. You set the pin in <code>setup()</code>. Then you toggle it HIGH/LOW in <code>loop()</code>.</div>
<div class='card'>The <code>loop()</code> keeps running until power is cut off. So, all repeating logic — like checking sensors or blinking LEDs — goes here.</div>
<div class='card'>We'll keep referring to this format in every future sketch. So memorize this like your own name. 🤓</div>
<button class='gaming-btn' onclick='revealNextCard(this)'>Show Next</button>`,
              image: "url",
              audio: "url"
            }
